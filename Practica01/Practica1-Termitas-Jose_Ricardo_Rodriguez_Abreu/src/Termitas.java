...
/**
 * 
 * @author Verónica Arriola, Rodriguez Abreu José Ricardo.
 * @date Feb, 17.
 */
public class Termitas extends PApplet {
    ...
    class ModeloTermitas{
      ...
      */
	  ...
	  int dif = rnd.nextInt(2);
	  if(rnd.nextBoolean())
	      return direccion+dif % 8;
	  else
	      return direccion-dif % 8;  
      }
      ...
      */
	  ...
	  int y = t.posY;
	  moverTermita(t,dir);
	  boolean resultado = mundo[t.posY][t.posX].estado;
	  t.posX = x;
	  t.posY = y;
	  return resultado;	  
       }
      ...
      */
	  ...
	  t.direccion = direccionAleatoriaFrente((dir + 4) % 8);
